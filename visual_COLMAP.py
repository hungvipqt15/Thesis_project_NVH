...
# Explicitly select the backend for imageio
# imageio.v3.set_plugin('pillow') 
 # You can use 'pillow', 'ffmpeg', etc., based on your needs

def main(
    colmap_path: Path = Path(__file__).parent / "colmap_sparse/0",
    images_path: Path = Path(__file__).parent / "uploads/images",
    ...
    need_update = [True]  # Use a list to allow modification in inner functions
